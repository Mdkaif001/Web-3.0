...
const ExploreCard = ({ id, imgUrl, title, index, active, handleClick }) => (
  ...
  >
    ...
    />
    {active !== id ? (
      <h3 className="font-semibold sm:text-[26px] text-[18px] text-white absolute z-0 lg:bottom-10 lg:rotate-[-90deg] lg:origin-[0,0] lg:w-[30px]">
        {title}
      </h3>
    ) : (
      <div className="absolute bottom-0 p-8 flex flex-col justify-start w-full bg-[rgba(0,0,0,0.5)] rounded-b-[24px]">
        ...
        <p className="font-normal text-[16px] leading-[20px] text-white uppercase">Enter the mertaverse</p>
